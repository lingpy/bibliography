...
<div id="wrapper">
 ...
 <div id="contentwrapper" class="clearfix">
     <div id="content">    
	 <!-- SIDEBAR about -->
<table id="normaltable" align=center width="100%" style="background-color:white;font-size:+100%">
<tr>
<td colspan=2>
<p>
...
titles (currently 3190 entries, few have been removed, as they turned out to be
...
With release 0.22, all new releases of the database (in form of BibTex files) will be uploaded to <a href="https://zenodo.org">Zenodo</a>, 
